...
module.exports = {
  ...
  createHasManyAssociationTable: function(client, tableName1, tableName2, cb) {
    ...
    var tableName = tableName1 + '_to_' + helpers.pluralize(tableName2),
  ...
  dropHasManyAssociationTable: function(client, tableName1, tableName2, cb) {
    var tableName = jaz.String.underscore(tableName1) + '_to_' + helpers.pluralize(jaz.String.underscore(tableName2));
