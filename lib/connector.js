...
module.exports = function connector(config) {
  ...
  object.dropTable = function(tableName, cb) {
    return Table.drop(_client, tableName, cb);
  };

  object.createHasManyAssociationTable = function(tableName1, tableName2, cb) {
    Table.createHasManyAssociationTable(_client, tableName1, tableName2, cb);
  };

  object.dropHasManyAssociationTable = function(tableName1, tableName2, cb) {
    Table.dropHasManyAssociationTable(_client, tableName1, tableName2, cb);
  };
