...
TableUpdater.prototype.sync = function(client, cb) {
  ...
  client.query(sql, function(err) {
    if (err) {
      cb(
        err.number === 1146 ?
          new errors.TableNotFoundError("Table '" + this.tableName + "' does not exist.") : 
          err.number === 1091 ? 
 ...
 */
TableUpdater.prototype.addHasOneColumn = function(table, options) {
  options = options || {};
 ...
 */
TableUpdater.prototype.removeHasOneColumn = function(key) {
