var mysql            = require('mysql'),
    ...
    QUERY_FIND_FIRST = 'SELECT * FROM `#{tableName}` LIMIT 1;',
    QUERY_FIND_ID    = 'SELECT * FROM `#{tableName}` WHERE id=? LIMIT 1;',
    QUERY_FIND_WHERE = 'SELECT * FROM `#{tableName}` WHERE #{where} LIMIT 1;',
